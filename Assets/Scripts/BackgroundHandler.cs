...
public class BackgroundHandler : MonoBehaviour
{
    ...
    public void backgroundLoop(GameObject centerRef, List<GameObject> backgroundImgObjs, int lastBackgroundImageElement, float playerDisp)
    {
    	...
    	backgroundImgObjs[lastBackgroundImageElement].transform.position = new Vector3(backgroundX, backgroundImgObjs[lastBackgroundImageElement].transform.position.y + (playerDisp*(backgroundImgObjs.Count)), transform.position.z);
